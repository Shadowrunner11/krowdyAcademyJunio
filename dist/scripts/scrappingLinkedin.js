(() => {
  ...
  async function scrap() {
    ...
    const response = await import_axios.default.get("https://www.linkedin.com/voyager/api/identity/profiles/andreina-nathaly-rodriguez-martinez/profileContactInfo", {
      headers: {
